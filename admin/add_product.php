        ...
        if (empty($error)) {
            ...
            $stmt = $pdo->prepare("
                INSERT INTO products (
                    ...
                    compare_price, stock, min_stock, category_id,
                    brand, image_url, prescription_required, is_featured, is_active
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ");
            $result = $stmt->execute([
                $name, $slug, $description, $short_description, $price,
...
<div class="admin-layout">
    <aside class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li><a href="add_product.php" class="active"><i class="fas fa-plus-circle"></i> Ajouter un produit</a></li>
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="slug" class="form-control" placeholder="ex: paracetamol-500mg">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <input type="number" name="price" class="form-control" required step="0.01" placeholder="0.00" value="0">
                        </div>
                        <div class="form-group">
                            <label>Prix comparatif</label>
                            <input type="number" name="compare_price" class="form-control" step="0.01" placeholder="0.00">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <label>Marque</label>
                            <input type="text" name="brand" class="form-control" placeholder="Marque du produit">
                        </div>
                    </div>

                    <div class="form-group">
                        <label>Description courte</label>
                        <input type="text" name="short_description" class="form-control" placeholder="Brève description (max 500 caractères)">
                    </div>

                    <div class="form-group">
                        <label>Description complète</label>
                        <textarea name="description" class="form-control" rows="6" placeholder="Description détaillée du produit"></textarea>
                    </div>
